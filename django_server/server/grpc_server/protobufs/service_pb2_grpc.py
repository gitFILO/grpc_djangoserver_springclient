...
from server.grpc_server.protobufs import service_pb2 as service__pb2
...
class ExampleServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendMessage = channel.unary_unary(
                '/grpc_example.ExampleService/SendMessage',
...
def add_ExampleServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'grpc_example.ExampleService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('grpc_example.ExampleService', rpc_method_handlers)
